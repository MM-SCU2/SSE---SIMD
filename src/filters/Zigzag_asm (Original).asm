...
.loopCero:
	...
	;ahora tengo que pasarlo a 32 bits, de nuevo primero la parte baja seria el pixel 0
	PUNPCKLWD xmm4,xmm3
	...
	;Ahora tengo que pasarlo a 32 bits, de nuevo primero la parte baja del desempaquetado seria el pixel 2
	PUNPCKLWD xmm5,xmm6
    ...
    ; xmm3 = p4       
 	...
 	;primero hay que acomodar p4, usamos un shuffle con una mascara para organizar de a bytes,
...
; ~~~~~~~~~~~~~~~~++++++++++++ MODIFICACION DE LOS ULTIMOS PIXELES ++++++++++++~~~~~~~~~~~~~~~~~~~~
	...
	add rdi,16 ; necesito esto para que se pare en la ante Ultima tanda, 
